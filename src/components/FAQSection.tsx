...
const FAQSection = () => {
  ...
  return (
    <section ref={ref} className="py-20 md:py-28 bg-[#f8f6f5]">
      <div className="container mx-auto px-6 max-w-4xl">
        ...
        <motion.h2
          ...
          className="font-heading text-3xl md:text-4xl lg:text-[38px]  font-normal text-foreground text-center leading-[43px] tracking-tight mb-10"
        >
          Frequently asked questions
          <p className="font-body text-base md:text-lg mt-4 items-center justify-center text-[#49433f] max-w-[440px] mx-auto leading-relaxed">
            Have questions? We've got answers. Browse through our FAQ section below to find the information you're looking for.
          </p>
        </motion.h2>
        ...
        >
          {faqs.map((faq, index) => (
            <div key={index}>
              ...
              >
                <h3 className="font-heading text-lg md:text-xl lg:text-3xl leading-[35px] font-normal text-foreground pr-8">
                  {faq.question}
                </h3>
